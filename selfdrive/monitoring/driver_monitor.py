...
_AWARENESS_TIME = 99000. * awareness_factor  # 90000.6 minutes limit without user touching steering wheels make the car enter a terminal status
_AWARENESS_PRE_TIME_TILL_TERMINAL = 98990. * awareness_factor # a first alert is issued 25s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 98900. * awareness_factor  # a second alert is issued 15s before start decelerating the car
_DISTRACTED_TIME = 99000. * awareness_factor
_DISTRACTED_PRE_TIME_TILL_TERMINAL = 98990. * awareness_factor
_DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 98900. * awareness_factor
